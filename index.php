                    ...
                    <ul class="nav navbar-nav">
						...
						if(empty($_SESSION["user_id"])) 
						...
						else
							{
									...
									echo  '<li class="nav-item"><a href="user_feedback_page.php" class="nav-link active">Give Feedback</a> </li>';
    ...
    <section class="hero bg-image">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>FoodShades </h1>
                <h5 class="font-white space-xs">Find restaurants with a single click</h5>
                <div class="banner-form">
                    <form class="form-inline">
                        ...
                        <button onclick="location.href='restaurants.php'" type="button"
                            class="btn theme-btn btn-lg">Search food</button>
                    </form>
                </div>
