						...
						if(empty($_SESSION["user_id"]))
							{
							  ...
							  <li class="nav-item"><a href="registration.php" class="nav-link active">signup</a> 
                       </li><li class="nav-item"><a href="admin/index.php" class="nav-link active">Admin login</a> </li>
